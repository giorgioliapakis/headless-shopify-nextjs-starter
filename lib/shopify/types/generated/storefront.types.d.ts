...
export type CartCompletionAction = CompleteFacilitatedPaymentChallenge | CompletePaymentChallenge;
...
export type CartCompletionDeliveryGroup = {
  __typename?: 'CartCompletionDeliveryGroup';
  /** The cost of the selected delivery option. */
  amount: MoneyV2;
  /** The code of the selected delivery option. */
  code?: Maybe<Scalars['String']['output']>;
  /** The address to where the order will be shipped. */
  deliveryAddress?: Maybe<MailingAddress>;
  /** The type of delivery method for the selected delivery option. */
  deliveryMethodType?: Maybe<DeliveryMethodType>;
  /** The delivery promise for the selected delivery option. */
...
export type CartCompletionDiscountAllocation = {
  __typename?: 'CartCompletionDiscountAllocation';
  /** The code used to apply the discount. */
  code?: Maybe<Scalars['String']['output']>;
  /** The amount of the discount allocated to the order. */
  discountedAmount: MoneyV2;
  /** The type of line that the discount is applicable towards. */
  targetType: DiscountApplicationTargetType;
  /** The title of the discount. */
...
/** Represents a order line in an order created from cart completion. */
export type CartCompletionOrderLineItem = {
  __typename?: 'CartCompletionOrderLineItem';
  /** The amount of the line item per quantity, not including any discounts. */
  amountPerQuantity: MoneyV2;
  /** The discounts that have been allocated to the line item. */
  discountAllocations: Array<CartCompletionDiscountAllocation>;
  /** The number of products variants associated to the line item. */
  quantity: Scalars['Int']['output'];
  /** The subtotal price of the line item, not including any discounts. */
  subtotalAmount: MoneyV2;
  /** The title of the product combined with title of the variant. */
  title: Scalars['String']['output'];
  /** The total price of the line item, including discounts. */
  totalAmount: MoneyV2;
};

/** The summary of an order created from cart completion. */
export type CartCompletionOrderSummary = {
  __typename?: 'CartCompletionOrderSummary';
  /** The identifier for the checkout session. */
  checkoutSessionIdentifier?: Maybe<Scalars['String']['output']>;
  /** A customer-facing order identifier. */
  confirmationNumber?: Maybe<Scalars['String']['output']>;
  /** List of delivery groups for the order. */
  deliveryGroups: Array<CartCompletionDeliveryGroup>;
  /** The discounts that have been allocated to the entire order and shipping. */
  discountAllocations: Array<CartCompletionDiscountAllocation>;
  /** List of the order's line items. */
  lineItems: Array<CartCompletionOrderLineItem>;
  /** The subtotal of the order before duties, shipping and taxes. */
  subtotalAmount?: Maybe<MoneyV2>;
  /** The total cost of the order, including duties, taxes and discounts. */
  totalAmount: MoneyV2;
  /** The total cost of duties. */
  totalDutyAmount?: Maybe<MoneyV2>;
  /** The total cost of shipping. */
  totalShippingAmount: MoneyV2;
...
export type CartCompletionSuccess = {
  ...
  /** The summary of the order created from cart completion. */
  orderSummary?: Maybe<CartCompletionOrderSummary>;
...
export enum CartErrorCode {
  ...
  /** The cart requires redirect to checkout. */
...
/** The action for the facilitated 3DS payment challenge. */
export type CompleteFacilitatedPaymentChallenge = {
  __typename?: 'CompleteFacilitatedPaymentChallenge';
  /** The reference ID for the facilitated 3DS payment challenge. */
...
export type QueryRootCartCompletionAttemptArgs = {
  ...
  requiredActionCompleted?: InputMaybe<Scalars['Boolean']['input']>;
};
...
export type Shop = HasMetafields & Node & {
  ...
  marketingConsentPreselected: Scalars['Boolean']['output'];
  /** Whether the marketing consent checkbox should be shown on the customer sign-in web component. */
  marketingConsentSigninEnabled: Scalars['Boolean']['output'];
  /** A [custom field](https://shopify.dev/docs/apps/build/custom-data), including its `namespace` and `key`, that's associated with a Shopify resource for the purposes of adding and storing additional information. */
  metafield?: Maybe<Metafield>;
  /** A list of [custom fields](/docs/apps/build/custom-data) that a merchant associates with a Shopify resource. */
  metafields: Array<Maybe<Metafield>>;
 ...
 *
 */
export type ShopContactInformationArgs = {
 ...
 *
 */
export type ShopLegalNoticeArgs = {
  sanitized?: InputMaybe<Scalars['Boolean']['input']>;
};
 ...
 *
 */
export type ShopTermsOfSaleArgs = {
  sanitized?: InputMaybe<Scalars['Boolean']['input']>;
};
...
export enum UserErrorsShopPayPaymentRequestSessionUserErrorsCode {
  ...
  /** Payment request session has already been submitted. */
  PaymentRequestSessionAlreadySubmitted = 'PAYMENT_REQUEST_SESSION_ALREADY_SUBMITTED'
}
